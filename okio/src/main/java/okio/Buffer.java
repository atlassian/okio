...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
  ...
  @Override public long readHexadecimalUnsignedLong() {
    ...
    if (seen == 0) {
      assert head != null; // Head is only null after processing at least one character.
      throw new NumberFormatException(
          "Expected leading hex character but was 0x" + Integer.toHexString(head.data[head.pos]));
    }
